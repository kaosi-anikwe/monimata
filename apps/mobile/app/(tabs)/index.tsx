...
const s = StyleSheet.create({
  ...
  balActions: { flexDirection: 'row', gap: spacing.smd },
  balBtnGhost: {
    flex: 1,
  ...
  // Sections
  sec: { paddingHorizontal: spacing.xl, paddingTop: spacing.mdn },
  secRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  secTitle: { ...type_.h3 },
  secLink: { ...type_.bodyReg },

  // Stats grid
  statGrid: { flexDirection: 'row', gap: spacing.smd },
  statCard: {
    flex: 1,
  ...
  streakNum: { ...type_.displayNum },
  streakNumSm: { ...type_.bodyReg },
  streakDesc: { ...type_.bodyReg, marginTop: spacing.xxs },
  streakBadge: {
  ...
  sdSym: { ...type_.small, color: glass.streakDay },
